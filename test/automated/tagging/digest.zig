...
test "Digests, From Tuple" {
    ...
    try std.testing.expect(digests[0] == Digest.tag("some_tag"));
    try std.testing.expect(digests[1] == Digest.tag("other_tag"));
    try std.testing.expect(digests[2] == Digest.tag("yet_another_tag"));
}
